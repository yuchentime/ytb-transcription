...
const zhCNMessages = {
  ...
  'settings.translateApiKey': '{provider} API Key',
  'settings.translateBaseUrl': '{provider} Base URL',
  'settings.ttsApiKey': '{provider} API Key',
  'settings.ttsBaseUrl': '{provider} Base URL',
