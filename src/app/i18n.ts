...
const zhMessages = {
  ...
  'task.voicePreset': '音色预设',
  'task.selectVoice': '请选择音色',
  'task.ttsSpeed': '语速（0.5 ~ 2）',
  'task.ttsPitch': '音调（-10 ~ 10）',
  ...
  'history.title': '历史记录',
  'history.keyword': '关键词',
  'history.keywordPlaceholder': '搜索链接/标题/作者',
  'history.status': '状态',
  ...
  'history.target': '目标',
  'history.videoTitle': '视频标题',
  'history.videoAuthor': '作者',
  'history.url': '链接',
  'history.actions': '操作',
  ...
  'settings.ttsTargetLanguage': 'TTS 目标语言',
  ...
  'settings.updateDownload': '下载新版本 {version}',
  'settings.updateDownloading': '下载中 {percent}%',
  'settings.updateDownloadingWithSpeed': '下载中 {percent}%（{speed}）',
  'settings.updateInstall': '安装更新并重启',
  'settings.updateRetry': '重试',
  'settings.updateStatusChecking': '正在检查更新...',
  'settings.updateStatusAvailable': '发现新版本 {version}',
  'settings.updateStatusDownloaded': '更新已下载，点击安装',
  'settings.updateStatusNotAvailable': '已是最新版本',
  'settings.updateStatusError': '检查更新失败：{message}',
  ...
  'settings.provider.qwen': 'Qwen3（中国/新加坡/美国）',
  'settings.provider.qwen.cn': 'Qwen3（中国）',
  'settings.provider.qwen.sg': 'Qwen3（新加坡）',
  'settings.provider.qwen.us': 'Qwen3（美国）',
  'settings.provider.kimi': 'Kimi (Moonshot)',
  'settings.provider.custom': '自定义(OpenAI-compatible)',
  'settings.provider.piper': '本地语音合成（Piper）',
  'settings.qwenRegionPreset': 'Qwen Base URL 区域',
  'settings.qwenRegionHint': '根据 API Key 所属地域选择（中国/新加坡/美国）。',
  ...
  'validation.piperModelPathRequired': '请先在设置页配置 Piper 模型路径',
  'validation.voicePresetRequired': '请选择音色预设',
  'validation.voiceNotFound': '音色不存在，请重新选择',
  'validation.voiceLanguageMismatch': '音色语言({voiceLang})与目标语言({targetLang})不一致',
...
const enMessages: Messages = {
  ...
  'task.voicePreset': 'Voice Preset',
  'task.selectVoice': 'Select Voice',
  'task.ttsSpeed': 'Speed (0.5 ~ 2)',
  'task.ttsPitch': 'Pitch (-10 ~ 10)',
  ...
  'history.keywordPlaceholder': 'Search URL/title/author',
  ...
  'history.videoTitle': 'Video Title',
  'history.videoAuthor': 'Author',
  'history.url': 'URL',
  ...
  'settings.group.update': 'Software Updates',
  ...
  'settings.ttsTargetLanguage': 'TTS Target Language',
  ...
  'settings.updateDownload': 'Download {version}',
  'settings.updateDownloading': 'Downloading {percent}%',
  'settings.updateDownloadingWithSpeed': 'Downloading {percent}% ({speed})',
  'settings.updateInstall': 'Install and Restart',
  'settings.updateRetry': 'Retry',
  'settings.updateStatusChecking': 'Checking for updates...',
  'settings.updateStatusAvailable': 'Update available: {version}',
  'settings.updateStatusDownloaded': 'Update downloaded. Click install.',
  'settings.updateStatusNotAvailable': 'You are on the latest version',
  'settings.updateStatusError': 'Update check failed: {message}',
  ...
  'settings.provider.qwen': 'Qwen3 (China/Singapore/US)',
  'settings.provider.qwen.cn': 'Qwen3 (China)',
  'settings.provider.qwen.sg': 'Qwen3 (Singapore)',
  'settings.provider.qwen.us': 'Qwen3 (US)',
  'settings.provider.kimi': 'Kimi (Moonshot)',
  'settings.provider.custom': 'Custom (OpenAI-compatible)',
  'settings.provider.piper': 'Local TTS (Piper)',
  'settings.qwenRegionPreset': 'Qwen Base URL Region',
  'settings.qwenRegionHint': 'Pick the endpoint that matches your API key region (China/Singapore/US).',
  ...
  'validation.piperModelPathRequired': 'Please configure Piper model path in Settings first',
  'validation.voicePresetRequired': 'Please select a voice preset',
  'validation.voiceNotFound': 'Voice not found, please select again',
  'validation.voiceLanguageMismatch': 'Voice language ({voiceLang}) does not match target language ({targetLang})',
